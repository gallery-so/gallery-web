...
- [Known Issues & Technical Debt](docs/KNOWN-ISSUES.md) — consolidated TODOs and known bugs
- [Third-Party Dependencies](docs/DEPENDENCIES.md) — external services, API keys, and subscriptions
...
See [apps/mobile/README.md](apps/mobile/README.md) for the full guide. Quick start:
