...
import { HEIGHT_OPENGRAPH_IMAGE, WIDTH_OPENGRAPH_IMAGE } from './fallback';
...
export async function generateSplashImageResponse({
  ...
  const [alpinaLightFontData, alpinaLightItalicFontData] = await Promise.all([
    alpinaLight(req),
    alpinaLightItalic(req),
  ]);
