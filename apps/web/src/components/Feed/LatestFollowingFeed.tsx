  ...
  return noViewerFeedEvents ? (
    <StyledEmptyFeed gap={12}>
      <VStack align="center">
        ...
        <StyledEmptyFeedBody>
          Discover new collectors and creators to follow in your <strong>Latest</strong> feed.
        </StyledEmptyFeedBody>
      </VStack>
      <VStack>
        <Button
          eventElementId="Take Me To Latest Feed Button"
          eventName="Visit Latest Feed"
