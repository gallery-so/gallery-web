...
export function FeaturePage({
  pageContent,
  ctaAuthenticatedButtonRoute: _ctaAuthenticatedButtonRoute,
  eventProperties,
}: Props) {
  void _ctaAuthenticatedButtonRoute;
  const ctaButtonRoute: Route = { pathname: '/home', query: {} };
        ...
        <StyledIntro align="center" gap={48}>
          ...
          <GalleryLink to={ctaButtonRoute} {...eventProperties}>
            <GetStartedButton eventElementId={null} eventName={null} eventContext={null}>
              <TitleDiatypeL color={colors.white}>Explore Gallery</TitleDiatypeL>
            </GetStartedButton>
          </GalleryLink>
        </StyledIntro>
