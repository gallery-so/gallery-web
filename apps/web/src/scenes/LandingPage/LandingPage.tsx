        ...
        <FullWidthVStack justify="center" align="center">
          <PageGutterWrapper gap={isDesktop ? 64 : 32}>
            <VStack gap={32} align="center" justify="center">
              ...
              <StyledText>
                {IS_READ_ONLY_MODE
                  ? 'Gallery web is now read-only. Browse on web, or use the iOS app for the transition experience.'
                  : 'Now you can share, discover and connect wherever you are.'}
              </StyledText>
            </VStack>
            <VStack gap={24} align="center">
              ...
              <BaseXL color={colors.metal}>
                {IS_READ_ONLY_MODE ? 'Web remains available for browsing' : 'Android coming soon'}
              </BaseXL>
            </VStack>
          </PageGutterWrapper>
        </FullWidthVStack>
